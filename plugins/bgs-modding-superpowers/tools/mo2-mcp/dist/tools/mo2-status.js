 ...
 */
function resolveActiveProfile(args, ctx, _ini) {
        ...
        if (!profileName) {
            return {
                ...
                error: {
                    ...
                    message: "No profile resolved. The binding resolves args.profile, then $BGS_MO2_PROFILE, then ModOrganizer.ini selected_profile, then allowed_profiles[0].",
                },
            };
        }
