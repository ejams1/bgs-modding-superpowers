...
const handler = {
    ...
    async applyMutation(plan, ctx) {
        ...
        await logApplyEvent(handler.toolName, `${adopted ? "adopted" : "created"} separator "${sepName}" wins_over="${winsOver ?? "none"}" → priority ${reportedPriority}`, bound, plan.planId, profile);
